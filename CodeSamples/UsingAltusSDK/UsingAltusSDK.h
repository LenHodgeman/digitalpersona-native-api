...
// DigitalPersona Altus Authentication SDK for a few standard cases.  
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// The authentication is done with the authentication policy configured by the Altus administrator.
	...
	LRESULT AuthenticateUserProvidingParameters(WORD, WORD, HWND hWnd, BOOL& bHandled) {
		...
		if (IDOK == dlg.DoModal()) { // Show dialog to get name of the secret to be released (the secret must have been saved before)
			...
			HRESULT hr = DPAlAuthenticate(m_hWnd,                       // Handle of the parent window (this dialog)
			                               L"Altus SDK Sample",         // Caption for the authentication dialog
	...
	// The standard authentication policy, configured by the Altus administrator, is used.
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Authentication is done with the authentication policy configured by the Altus administrator.
	...
	// Identification is done in accordance with the authentication policy configured by the Altus administrator.
	...
	// The identification is done in accordance with the authentication policy configured by the Altus administrator.
	// No secrets are released, no strings are provided to the identification dialog. 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// The user must be an Altus (or Altus AD) user, otherwise the secret will not be found.
...
//
	...
	// configured by the Altus administrator, and it is not guaranteed that these credentials exist in the custom policy.
